...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(7, 28%, 71%)" },
          20: { value: "hsl(6, 28%, 65%)" },
          40: { value: "hsl(7, 28%, 53%)" },
          60: { value: "hsl(7, 40%, 41%)" },
          80: { value: "hsl(7, 40%, 33%)" },
          90: { value: "hsl(6, 40%, 25%)" },
          100: { value: "hsl(6, 39%, 21%)" },
        },
        secondary: {
          10: { value: "hsl(78, 5%, 61%)" },
          20: { value: "hsl(80, 5%, 53%)" },
          40: { value: "hsl(80, 8%, 38%)" },
          60: { value: "hsl(79, 17%, 22%)" },
          80: { value: "hsl(80, 16%, 18%)" },
          90: { value: "hsl(80, 18%, 13%)" },
          100: { value: "hsl(80, 16%, 11%)" },
        },
      },
      font: {
        primary: { value: "hsl(0, 0%, 0%)" },
        secondary: { value: "hsl(60, 6%, 91%)" },
        tertiary: { value: "{colors.neutral.80.value}" },
        disabled: { value: "{colors.brand.secondary.80.value}" },
        ...
        active: { value: "{colors.brand.secondary.100.value}" },
        info: { value: "{colors.blue.90.value}" },
        warning: { value: "{colors.yellow.60.value}" },
        error: { value: "hsl(0, 88%, 40%)" },
